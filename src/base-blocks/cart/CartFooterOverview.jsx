  ...
  return (
    <div className="flex items-center justify-between bg-slate-700 px-6 py-3 text-sm font-semibold uppercase text-slate-200 sm:px-10 md:py-4 md:text-base">
      <p className="space-x-3 text-slate-300 sm:space-x-5">
        <span>
          <em className="mr-2 rounded-md bg-purple-400 px-2 py-1 text-slate-800 shadow-custom_shadow_6">
            {totalCartQuantity}
          </em>{" "}
          pizzas
        </span>
      ...
      <Link to="/cart" className="relative flex items-center gap-2 md:gap-4">
        ...
        <p className="absolute right-[-7px] top-[-6px] h-[14px] w-[14px] rounded-full bg-purple-200 text-center text-[8px] text-slate-800 shadow-custom_shadow_6 md:right-[-8px] md:top-[-5px] md:h-4 md:w-4 md:text-xs">
          {totalCartQuantity}
        </p>
      </Link>
    </div>
