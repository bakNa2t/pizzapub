...
function MainPage() {
  ...
  const logo = (
    ...
    >
      <g>
        <path
          d="M22.887,21.146c0,1.229,0.479,2.386,1.35,3.256c0.195,0.195,0.451,0.293,0.707,0.293c0.256,0,0.512-0.098,0.707-0.293
   ...
   C23.366,18.761,22.887,19.917,22.887,21.146z"
        />
        <path
          d="M12,21.146c0,1.229,0.479,2.386,1.35,3.256c0.195,0.195,0.451,0.293,0.707,0.293c0.256,0,0.512-0.098,0.707-0.293
   ...
   c-0.391-0.391-1.023-0.391-1.414,0s-0.391,1.023,0,1.414c1.015,1.016,1.015,2.668,0,3.684C12.479,18.761,12,19.917,12,21.146z"
        />
        <path
          d="M17.887,18.146c0,1.229,0.479,2.386,1.35,3.256c0.195,0.195,0.451,0.293,0.707,0.293c0.256,0,0.512-0.098,0.707-0.293
   c0.391-0.391,0.391-1.023,0-1.414c-0.492-0.492-0.764-1.146-0.764-1.842s0.271-1.35,0.764-1.842c1.795-1.795,1.795-4.717,0-6.512
   c-0.391-0.391-1.023-0.391-1.414,0s-0.391,1.023,0,1.414c1.015,1.016,1.015,2.668,0,3.684
   C18.366,15.761,17.887,16.917,17.887,18.146z"
        />
        <path
          d="M57.846,47.093c0.013-0.159,0.011-0.319-0.027-0.479l-7.754-19.972l4.906-19.903c0.008-0.034-0.003-0.068,0.002-0.102
  ...
  return (
    <div className="xl:my-66 my-20 px-5 text-center sm:my-40 lg:my-56 2xl:my-[28rem]">
      <div className="mx-auto my-0 flex w-fit items-center gap-4">
